...
template=llama2
dataset_dir=${base_path}/evaluation/mkqa/eng_instruct_data

langs=('no' 'da' 'fi' 'hu' 'ja' 'ko' 'pt' 'vi' 'pl')

for lang in ${langs[*]}
do
# English instruct
dataset=${lang}
output_dir=/home/export/base/ycsc_chenkh/hitici_02/online1/PolyLingual-LLM/LLM-SFT_pred_output/mkqa_eng_instruct_alpaca_en_llama2-7b/${dataset}
