...
template=llama2
dataset_dir=${base_path}/evaluation/belebele/eng_instruct_data
...
# English instruct
dataset=${lang}
output_dir=/home/export/base/ycsc_chenkh/hitici_02/online1/PolyLingual-LLM/LLM-SFT_pred_output/belebele_eng_instruct_alpaca_en_llama2-7b/${dataset}
