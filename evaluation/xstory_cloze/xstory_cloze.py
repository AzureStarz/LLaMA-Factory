...
_DATA_DIR = "/home/export/base/ycsc_chenkh/hitici_02/online1/PolyLingual-LLM/LLaMA-Factory/evaluation/xstory_cloze"
...
class XStoryCloze(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        datasets.BuilderConfig(name=lang,
                                description=f"XStoryCloze Test Spring 2016 {lang} set")
        for lang in _LANG
    ]
    ...
    def _split_generators(self, dl_manager):
        ...
        filepaths = {
            ...
            "test": os.path.join(_DATA_DIR, 'data/test', _URL_FORMAT.format(lang=name, split="eval")),
        }
